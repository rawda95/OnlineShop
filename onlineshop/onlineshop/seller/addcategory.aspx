        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form">
                    ...
                    <div class="form-group">
                        <h2>choses from category  </h2>
                        <asp:DropDownList runat="server" ID="ddl_category" DataValueField="id" ValidationGroup="select"></asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Style="flex: auto" classs="col-sm-6 form-control" runat="server" ControlToValidate="ddl_category" ErrorMessage="select category" ForeColor="Red" ValidationGroup="select">*</asp:RequiredFieldValidator>

                    </div>
                    <div class="clearfix form-group">
                        <asp:Button ID="btn_select" class="btn btn-primary  login-btn btn-block" runat="server" Text="select" ValidationGroup="select" OnClick="btn_select_Click" />
            ...
            <div class="col-sm-4">
                <div class="login-form">
                    ...
                    <div class="clearfix form-group">
                        <asp:Button ID="btn_add_category" class="btn btn-primary login-btn btn-block" runat="server" Text="add category" ValidationGroup="LogInSeller" OnClick="btn_add_category_Click" />
