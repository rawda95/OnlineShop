<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ProfileFinal.aspx.cs" Inherits="SignUpPage.ProfileFinal" %>
                            ...
                            <table style="width: 348px; margin-right: 0px">
                                <tr>
                                    ...
                                    <td style="width: 3px">
                                        ...
                                        <asp:RequiredFieldValidator ID="RF_ImgProile" runat="server" ErrorMessage="Please enter your Image" Text="*" ControlToValidate="FU_ImgProfile" ValidationGroup="Edit"  ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                  </tr>
                            </table>
                     </td>
                                           ...
                                           <td >
                                            ...
                                            <td>
                                                    <asp:Button ID="btn_cancel" runat="server" Text="Cancel"  Class="btn btn-primary" OnClick="btn_cancel_Click" Width="73px"  ValidationGroup="Edit"/>
                                                     &nbsp;<asp:Label ID="lbl_Cancel_Check" runat="server"  Text="" ValidationGroup="Edit"></asp:Label>
                                             </td>
